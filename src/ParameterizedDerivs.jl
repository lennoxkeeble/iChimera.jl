...
d9f_dt(df_dλ::Float64, dλ_dt::Float64, d2f_dλ::Float64, d2λ_dt::Float64, d3f_dλ::Float64, d3λ_dt::Float64, d4f_dλ::Float64, d4λ_dt::Float64, d5f_dλ::Float64, d5λ_dt::Float64, d6f_dλ::Float64, d6λ_dt::Float64, 
d7f_dλ::Float64, d7λ_dt::Float64, d8f_dλ::Float64, d8λ_dt::Float64, d9f_dλ::Float64, d9λ_dt::Float64)::Float64 = 945*dλ_dt*d2λ_dt^4*d5f_dλ + 1260*d2λ_dt^3*(d3λ_dt*d4f_dλ + dλ_dt^3*d6f_dλ) + 378*dλ_dt*d2λ_dt^2*(5*d4f_dλ*d4λ_dt + 10*dλ_dt*d3λ_dt*d5f_dλ + dλ_dt^4*d7f_dλ) + 42*(30*dλ_dt^2*d3λ_dt*d4f_dλ*d4λ_dt + 3*dλ_dt^4*d5f_dλ*d5λ_dt + 3*dλ_dt^5*d4λ_dt*d6f_dλ + d2f_dλ*(3*d4λ_dt*d5λ_dt + 2*d3λ_dt*d6λ_dt) + 2*dλ_dt^3*(10*d3λ_dt^2*d5f_dλ + d4f_dλ*d6λ_dt) + 2*dλ_dt^6*d3λ_dt*d7f_dλ) + d3f_dλ*(280*d3λ_dt^3 + 378*d2λ_dt^2*d5λ_dt + 252*d3λ_dt*(5*d2λ_dt*d4λ_dt + 2*dλ_dt*d5λ_dt) + 9*dλ_dt*(35*d4λ_dt^2 + 28*d2λ_dt*d6λ_dt + 4*dλ_dt*d7λ_dt)) + 36*d2λ_dt*(7*dλ_dt*(5*dλ_dt^2*d4λ_dt*d5f_dλ + d4f_dλ*(10*d3λ_dt^2 + 3*dλ_dt*d5λ_dt) + 5*dλ_dt^3*d3λ_dt*d6f_dλ) + d2f_dλ*d7λ_dt + dλ_dt^7*d8f_dλ) + 9*dλ_dt*d2f_dλ*d8λ_dt + dλ_dt^9*d9f_dλ + df_dλ*d9λ_dt

end


# MMA_vals = [-0.1874235296650666, -0.13403151472118424, 0.15887202578314402, 
#   0.14621407549728976, 0.10792534129042175, -1.1371493863348907, 
#   0.16940283236399367, 3.1278897532756074, 8.530896789241517]
...
# ParameterizedDerivs.df_dt(df_dλ, dλ_dt) ≈ MMA_vals[1]
# ParameterizedDerivs.d2f_dt(df_dλ, dλ_dt, d2f_dλ, d2λ_dt) ≈ MMA_vals[2]
# ParameterizedDerivs.d3f_dt(df_dλ, dλ_dt, d2f_dλ, d2λ_dt, d3f_dλ, d3λ_dt) ≈ MMA_vals[3]
# ParameterizedDerivs.d4f_dt(df_dλ, dλ_dt, d2f_dλ, d2λ_dt, d3f_dλ, d3λ_dt, d4f_dλ, d4λ_dt) ≈ MMA_vals[4]
# ParameterizedDerivs.d5f_dt(df_dλ, dλ_dt, d2f_dλ, d2λ_dt, d3f_dλ, d3λ_dt, d4f_dλ, d4λ_dt, d5f_dλ, d5λ_dt) ≈ MMA_vals[5]
# ParameterizedDerivs.d6f_dt(df_dλ, dλ_dt, d2f_dλ, d2λ_dt, d3f_dλ, d3λ_dt, d4f_dλ, d4λ_dt, d5f_dλ, d5λ_dt, d6f_dλ, d6λ_dt) ≈ MMA_vals[6]
# ParameterizedDerivs.d7f_dt(df_dλ, dλ_dt, d2f_dλ, d2λ_dt, d3f_dλ, d3λ_dt, d4f_dλ, d4λ_dt, d5f_dλ, d5λ_dt, d6f_dλ, d6λ_dt, d7f_dλ, d7λ_dt) ≈ MMA_vals[7]
# ParameterizedDerivs.d8f_dt(df_dλ, dλ_dt, d2f_dλ, d2λ_dt, d3f_dλ, d3λ_dt, d4f_dλ, d4λ_dt, d5f_dλ, d5λ_dt, d6f_dλ, d6λ_dt, d7f_dλ, d7λ_dt, d8f_dλ, d8λ_dt) ≈ MMA_vals[8]
# ParameterizedDerivs.d9f_dt(df_dλ, dλ_dt, d2f_dλ, d2λ_dt, d3f_dλ, d3λ_dt, d4f_dλ, d4λ_dt, d5f_dλ, d5λ_dt, d6f_dλ, d6λ_dt, d7f_dλ, d7λ_dt, d8f_dλ, d8λ_dt, d9f_dλ, d9λ_dt) ≈ MMA_vals[9]