...
function compute_chimera_self_accel!(aSF_H::AbstractVector,
    ...
    if coordinates == "harmonic"
        SelfAccelerationHarmonic.aRRα(aSF_H, aSF_BL, xH, v, vH, xBL, rH, spin, Vrr, ∂Vrr_∂t, Virr, ∂Vrr_∂a, ∂Virr_∂t, ∂Virr_∂a)
...
function compute_inspiral(a::Float64, p::Float64, e::Float64, θmin::Float64, sign_Lz::Int64, q::Float64, psi_0::Float64, chi_0::Float64, phi_0::Float64, compute_SF::Float64, tInspiral::Float64, dt_save::Float64, save_every::Int64, reltol::Float64=1e-14, abstol::Float64=1e-14, coordinates::String="cartesian"; data_path::String="Data/", JIT::Bool=false, lmax_mass_fluxes::Int64, lmax_current_fluxes::Int64, save_traj::Bool, save_constants::Bool, save_fluxes::Bool, save_gamma::Bool, maxiters::Int64=Int(1e8))
    ...
    while integrator.t < tInspiral
        ...
        if WF_step
            ...
            MultipoleDerivs.compute_SF_moments!(q, Mij5, Mij6, Mij7, Mij8, Mijk7, Mijk8, Sij5, Sij6, xH, dxH_dt, d2xH_dt, d3xH_dt, d4xH_dt, d5xH_dt, d6xH_dt, d7xH_dt, d8xH_dt, d9xH_dt)
            ...
            Vrr, ∂Vrr_∂t = RRPotentials.compute_RR_potentials!(Virr, ∂Vrr_∂a, ∂Virr_∂t, ∂Virr_∂a, xH, Mij5, Mij6, Mij7, Mij8, Mijk7, Mijk8, Sij5, Sij6);
            compute_chimera_self_accel!(aSF_H, aSF_BL, xH, dxH_dt, xBL, a, Vrr, ∂Vrr_∂t, Virr, ∂Vrr_∂a, ∂Virr_∂t, ∂Virr_∂a; coordinates=coordinates)
...
function load_fluxes(a::Float64, p::Float64, e::Float64, θmin::Float64, q::Float64, psi_0::Float64, chi_0::Float64, phi_0::Float64, lmax_mass_fluxes::Int64, lmax_current_fluxes::Int64, coordinates::String, data_path::String)
    sol_filename=solution_fname(a, p, e, θmin, q, psi_0, chi_0, phi_0, lmax_mass_fluxes, lmax_current_fluxes, coordinates, data_path)
